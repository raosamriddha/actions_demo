...
#define MyAppName "KF Comm 2C"
#define MyAppVersion "02.01.005"
...
#define RegKey "kfcomm2c"
#define RegValue "1DIY6YSK9YGDZHC2ZDT027B9QUXL0OGO"
#define VersionRegKey="kfcomm2CVersion"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{AA403830-F7FA-4CC1-9701-544647DFA235}
AppName={#MyAppName}
...
[InstallDelete]
Type: files; Name: {app}\bin\jre\UserManual\KFComm2C\*.pdf
Type: files; Name: {app}\bin\jre\UserManual\KFComm2C\*.xlsm

[Files]
Source: "C:\D_drive\setup_with_chrome\bin\jre\iKFComm2CBackup.bat"; DestDir: "{app}/bin/jre"; Flags: ignoreversion
Source: "C:\D_drive\setup_with_chrome\bin\jre\uKFComm2CBackup.bat"; DestDir: "{app}/bin/jre"; Flags: ignoreversion
...
[Run]
Filename: "{app}\bin\jre\iKFComm2CBackup.bat"; Flags: runhidden skipifdoesntexist; StatusMsg: "Backing up database..."
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: nowait postinstall skipifsilent

[UninstallRun]
Filename: "{app}\bin\jre\uKFComm2CBackup.bat"; Flags: runhidden skipifdoesntexist; StatusMsg: "Backing up database..."
