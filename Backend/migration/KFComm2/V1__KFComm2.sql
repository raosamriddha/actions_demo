...
Insert or ignore INTO "license_activation_status" VALUES (1,'w2rPXhKluU0CoxNe7P55jQ==');
Insert or Ignore INTO "cfr_status" VALUES (1,'Jc+OPAV3cqKd1IcLoHxRQQ==');
...
Insert or Ignore INTO "user_details" VALUES (1,1,'Dr.','Super','','Admin',NULL,'SuperAdmin@repligen.in','95444531689','Jan 20, 2020, 14:33:49');
Insert or Ignore INTO "user_details" VALUES (2,2,'Dr.','KFComm','','Admin','Dr. KFComm Admin','Admin@repligen.in','',NULL);
...
Insert or Ignore INTO "user_master" VALUES (1,'SuperAdmin','Active',' ','2019/03/14 17:03:58','SuperAdmin','Nov 22, 2019, 16:29:33',NULL);
Insert or Ignore INTO "user_master" VALUES (2,'Admin','Active','SuperAdmin','Nov 22, 2019, 11:14:38',NULL,NULL,' ');


Insert or Ignore INTO "user_role_map" VALUES (1,1,5,'Y');
Insert or Ignore INTO "user_role_map" VALUES (2,2,1,'Y');


Insert or Ignore INTO "role_master" VALUES (1,'Admin','Y');
Insert or Ignore INTO "role_master" VALUES (2,'Auditor','Y');
Insert or Ignore INTO "role_master" VALUES (3,'Manager','Y');
Insert or Ignore INTO "role_master" VALUES (4,'Technician','Y');
Insert or Ignore INTO "role_master" VALUES (5,'SuperAdmin','Y');

Insert or Ignore INTO "user_credentials" VALUES (1,1,'8kr4NA9GvzOYWYxD1zTuFQ==','D','Y','8kr4NA9GvzOYWYxD1zTuFQ==');

Insert or Ignore INTO "user_credentials" VALUES (2,2,'8kr4NA9GvzOYWYxD1zTuFQ==','D','Y','');

update "user_credentials" set master_password = '8kr4NA9GvzOYWYxD1zTuFQ==' where credential_id = 1;
update "user_credentials" set master_password = '8kr4NA9GvzOYWYxD1zTuFQ==' where credential_id = 2;
